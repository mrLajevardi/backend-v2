...
export class Test1705182363147 implements MigrationInterface {
  name = 'Test1705182363147';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user"."Invoices" ADD "FinalAmountWithTax"  AS ([FinalAmount]*((1)+[InvoiceTax])) PERSISTED NOT NULL`,
    );
    await queryRunner.query(
