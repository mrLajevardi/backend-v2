...
export class Test1705181786254 implements MigrationInterface {
    name = 'Test1705181786254'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user"."Invoices" ADD "FinalAmountWithTax"  AS (([FinalAmount]*((1)+[InvoiceTax])))`);
