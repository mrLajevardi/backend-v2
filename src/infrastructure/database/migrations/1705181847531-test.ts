...
export class Test1705181847531 implements MigrationInterface {
  name = 'Test1705181847531';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user"."Invoices" ADD "FinalAmountWithTax"  AS ([FinalAmount]*((1)+[InvoiceTax]))`,
    );
    await queryRunner.query(
