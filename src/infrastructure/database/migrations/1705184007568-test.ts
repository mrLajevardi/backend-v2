...
export class Test1705184007568 implements MigrationInterface {
    name = 'Test1705184007568'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user"."Invoices" ADD "FinalAmountWithTax"  AS ([FinalAmount]*((1)+[InvoiceTax])) PERSISTED`);
        await queryRunner.query(`INSERT INTO "Arad_V2".."typeorm_metadata"("database", "schema", "table", "type", "name", "value") VALUES (@0, @1, @2, @3, @4, @5)`, ["Arad_V2","user","Invoices","GENERATED_COLUMN","FinalAmountWithTax","[FinalAmount]*((1)+[InvoiceTax])"]);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DELETE FROM "Arad_V2".."typeorm_metadata" WHERE "type" = @0 AND "name" = @1 AND "database" = @2 AND "schema" = @3 AND "table" = @4`, ["GENERATED_COLUMN","FinalAmountWithTax","Arad_V2","user","Invoices"]);
        await queryRunner.query(`ALTER TABLE "user"."Invoices" DROP COLUMN "FinalAmountWithTax"`);
