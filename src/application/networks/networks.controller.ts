...
export class NetworksController {
    ...
    @ApiResponse({ status: 200, description: 'Returns the created dhcp binding', type: Object })
    async createDhcpBinding(
      ...
      return await this.service.dhcp.createDhcpBinding(
        options,vdcInstanceId,networkId,data); 
    }
    ...
    @ApiResponse({ status: 200, description: 'Returns the created network', type: Object })
    async createNetwork(
      @Request() options,
      @Param('vdcInstanceId') vdcInstanceId: string,
    ...
    @ApiResponse({ status: 200, description: 'Returns the deleted dhcp binding', type: Object })
    async deleteDhcpBinding(
      ...
      return await this.service.dhcp.deleteDhcpBinding(options,vdcInstanceId,networkId,bindingId);
    }
    ...
    @ApiParam({ name: 'vdcInstanceId', type: 'string' })
    @ApiParam({ name: 'networkId', type: 'string' })
    @ApiResponse({ status: 200, description: 'Returns the deleted dhcp of the specific network', type: Object })
    async deleteDhcp(
        @Request() options,
      @Param('vdcInstanceId') vdcInstanceId: string,
      @Param('networkId') networkId: string,
    ): Promise<object> {
      return await this.service.dhcp.deleteDhcp(options,vdcInstanceId,networkId);
    }
    ...
    @ApiParam({ name: 'networkId', type: 'string' })
    @ApiResponse({ status: 200, description: 'Returns the deleted network', type: Object })
    async deleteNetwork(
        @Request() options,
      @Param('serviceInstanceId') serviceInstanceId: string,
      @Param('networkId') networkId: string,
    ): Promise<object> {
      return await this.service.deleteNetwork(options,serviceInstanceId,networkId)
    }
    ...
    @ApiResponse({ status: 200, description: 'Returns the list of dhcp bindings', type: [DhcpBindingsDataDto] })
    async getAllDhcpBindings(
      ...
      return await this.service.dhcp.getAllDhcpBindings(options,vdcInstanceId,networkId,pageSize,getAll);
    }
    ...
    @ApiParam({ name: 'networkId', type: 'string' })
    @ApiParam({ name: 'bindingId', type: 'string' })
    @ApiResponse({ status: 200, description: 'Returns the dhcp binding', type: DhcpBindingsDataDto })
    async getDhcpBindingConfig(
      ...
      @Param('bindingId') bindingId: string,
        ...
        return this.service.dhcp.getDhcpBinding(options,vdcInstanceId,networkId,bindingId);
    }
    ...
    @ApiParam({ name: 'vdcInstanceId', type: 'string' })
    @ApiParam({ name: 'networkId', type: 'string' })
    @ApiResponse({ status: 200, description: 'Returns the dhcp of the specific network', type: GetDhcpDto })
    async getDhcp(
        @Request() options,
      @Param('vdcInstanceId') vdcInstanceId: string,
      @Param('networkId') networkId: string,
    ...
    @ApiResponse({ status: 200, description: 'Returns the list of networks', type: GetNetworksDto })
    async getNetworks(
        @Request() options,
      @Param('vdcInstanceId') vdcInstanceId: string,
      ...
      @Query('search') search?: string,
        ...
        return this.service.getNetworks(options,vdcInstanceId,page,pageSize, filter,search);
    }
    ...
    @ApiParam({ name: 'bindingId', type: 'string' })
    @ApiBody({ type: DhcpBindingsDataDto })
    @ApiResponse({ status: 200, description: 'Returns the updated dhcp binding', type: Object })
    async updateDhcpBinding(
      ...
      return this.service.dhcp.updateDhcpBinding(options,vdcInstanceId,networkId,bindingId,data);
    }
    ...
    @ApiResponse({ status: 200, description: 'Returns the updated or created dhcp service', type: Object })
    async updateDhcp(
        @Request() options,
      @Param('vdcInstanceId') vdcInstanceId: string,
      @Param('networkId') networkId: string,
      @Body() data: UpdateDhcpDto,
        ...
        return await this.service.dhcp.updateDhcp(options,vdcInstanceId,networkId,data);
    }
    ...
    @ApiParam({ name: 'networkId', type: 'string' })
    @ApiBody({ type: NetworkDto })
    @ApiResponse({ status: 200, description: 'Returns the updated network', type: Object })
    async updateNetwork(
        @Request() options,
      @Param('serviceInstanceId') serviceInstanceId: string,
      @Param('networkId') networkId: string,
      ...
      return await this.service.updateNetwork(data,options,serviceInstanceId,networkId);
    }
