...
export class PermissionGroupsMappingsController {
  ...
  @Get(':id')
  async findById(@Param('id') id: string): Promise<PermissionGroupsMappings> {
  ...
  @Put(':id')
  async update(@Param('id') id: string, @Body() dto: UpdatePermissionGroupsMappingsDto): Promise<void> {
