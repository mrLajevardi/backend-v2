...
import { CreateErrorLogDto } from 'src/application/base/log/error-log/dto/create-error-log.dto';
import { UpdateErrorLogDto } from 'src/application/base/log/error-log/dto/update-error-log.dto';
...
export class ErrorLogController {
  ...
  @Get(':id')
  async findById(@Param('id') id: number): Promise<ErrorLog> {
