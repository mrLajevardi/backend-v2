...
import { CreateSystemSettingsDto } from 'src/infrastructure/dto/create/create-system-settings.dto';
import { UpdateSystemSettingsDto } from 'src/infrastructure/dto/update/update-system-settings.dto';
...
export class SystemSettingsController {
  ...
  @Get(':id')
  async findById(@Param('id') id: number): Promise<SystemSettings> {
  ...
  @Post()
  async create(@Body() dto: CreateSystemSettingsDto): Promise<void> {
  ...
  @Put(':id')
  async update(@Param('id') id: number, @Body() dto: UpdateSystemSettingsDto): Promise<void> {
