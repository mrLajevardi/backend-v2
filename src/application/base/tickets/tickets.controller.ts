...
import { CreateTicketDto } from 'src/application/base/tickets/dto/create-ticket.dto';
import { UpdateTicketDto } from 'src/application/base/tickets/dto/update-ticket.dto';
...
export class TicketsController {
  ...
  @Get(':id')
  async findById(@Param('id') id: number): Promise<Tickets> {
  ...
  @Post()
  async create(@Body() dto: CreateTicketDto): Promise<void> {
  ...
  @Put(':id')
  async update(@Param('id') id: number, @Body() dto: UpdateTicketDto): Promise<void> {
