...
import { CreateInvoicePlansDto } from 'src/application/base/invoice/invoice-plans/dto/create-invoice-plans.dto';
import { UpdateInvoicePlansDto } from 'src/application/base/invoice/invoice-plans/dto/update-invoice-plans.dto';
...
export class InvoicePlansController {
  ...
  async update(
    @Param('id') id: number,
    @Body() dto: UpdateInvoicePlansDto,
  ): Promise<void> {
