...
import { CreateGroupsMappingDto } from 'src/application/base/user/groups-mapping/dto/create-groups-mappings.dto';
import { UpdateGroupsMappingDto } from 'src/application/base/user/groups-mapping/dto/update-groups-mappings.dto';
...
export class GroupsMappingController {
  ...
  async update(
    @Param('id') id: number,
    @Body() dto: UpdateGroupsMappingDto,
  ): Promise<void> {
