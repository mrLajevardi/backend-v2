...
describe('UserService', () => {
    ...
    const mockOtpService = {
        ...
        otpVerifier: jest.fn((phoneNumber: string, otp: string, hash: string): boolean => {
            return true;
        })
    }
    ...
    describe('email verifying', () => {
        ...
        it('should be return true if valid email , otp , hash for verifying email otp', async () => {
            ...
            jest.spyOn(service , 'verifyEmailOtp')
                .mockImplementation(async (options: SessionRequest, data: VerifyEmailDto,): Promise<boolean>=>{
