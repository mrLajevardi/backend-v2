...
import { CreatePermissionGroupsMappingsDto } from 'src/application/base/security/permission-groups-mappings/dto/create-permission-groups-mappings.dto';
import { UpdatePermissionGroupsMappingsDto } from 'src/application/base/security/permission-groups-mappings/dto/update-permission-groups-mappings.dto';
...
export class PermissionGroupsMappingsController {
  ...
  async update(
    @Param('id') id: number,
    @Body() dto: UpdatePermissionGroupsMappingsDto,
  ): Promise<void> {
