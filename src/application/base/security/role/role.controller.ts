...
import { CreateRoleDto } from 'src/application/base/security/role/dto/create-role.dto';
import { UpdateRoleDto } from 'src/application/base/security/role/dto/update-role.dto';
...
export class RoleController {
  ...
  @Post()
  async create(@Body() dto: CreateRoleDto): Promise<void> {
