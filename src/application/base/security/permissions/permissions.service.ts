...
import { CreatePermissionDto } from 'src/application/base/security/permissions/dto/create-permission.dto';
import { UpdatePermissionDto } from 'src/application/base/security/permissions/dto/update-permission.dto';
