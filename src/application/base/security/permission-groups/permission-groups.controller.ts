...
import { CreatePermissionGroupDto } from 'src/application/base/security/permission-groups/dto/create-permission-group.dto';
import { UpdatePermissionGroupDto } from 'src/application/base/security/permission-groups/dto/update-permission-group.dto';
