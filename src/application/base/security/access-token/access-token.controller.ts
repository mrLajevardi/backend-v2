...
import { CreateAccessTokenDto } from 'src/application/base/security/access-token/dto/create-access-token.dto';
import { UpdateAccessTokenDto } from 'src/application/base/security/access-token/dto/update-access-token.dto';
...
export class AccessTokenController {
  ...
  @Get(':id')
  async findById(@Param('id') id: string): Promise<AccessToken> {
  ...
  @Post()
  async create(@Body() dto: CreateAccessTokenDto): Promise<void> {
