...
export class UpdateIpSecVpnLocalVdcDto {
  @ApiProperty()
  @IsString()
  localId: string;
...
export class UpdateIpSecVpnRemoteVdcDto {
  @ApiProperty()
  @IsString()
  remoteId: string;
...
export class UpdateIpSecVpnVdcDto {
  @ApiProperty({
    type: String,
  ...
  @ApiProperty({
    type: UpdateIpSecVpnLocalVdcDto,
  })
  localEndpoint: UpdateIpSecVpnLocalVdcDto;

  @ApiProperty({
    type: UpdateIpSecVpnRemoteVdcDto,
  })
  remoteEndpoint: UpdateIpSecVpnRemoteVdcDto;
}
